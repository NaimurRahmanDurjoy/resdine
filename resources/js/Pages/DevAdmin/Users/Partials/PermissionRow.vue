    ...
    <tr class="group hover:bg-gray-50/80 dark:hover:bg-gray-800/40 transition-colors border-l-2"
        ...
        <td class="py-2.5 px-4">
            <div class="flex items-center gap-3" :class="{ 'pl-8': indent }">
                ...
                <!-- Status Badge -->
                <div v-if="currentOverride !== null" class="flex items-center gap-2">
        ...
        <td class="py-2.5 px-4 text-right">
            <div
                class="inline-flex p-1 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-inner">
                <!-- Allow (True) -->
                <button @click="toggle(true)" type="button"
                    ...
                    :class="currentOverride === true ? 'bg-emerald-500 text-white shadow-md shadow-emerald-500/20' : 'text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400'">
                    Allow
                </button>
                ...
                <button @click="toggle(false)" type="button"
                    class="px-4 py-1.5 rounded-lg text-[10px] font-bold uppercase tracking-widest transition-all"
                    :class="currentOverride === false ? 'bg-rose-500 text-white shadow-md shadow-rose-500/20' : 'text-gray-400 hover:text-rose-600 dark:hover:text-rose-400'">
                    Deny
                </button>
            </div>
        </td>
