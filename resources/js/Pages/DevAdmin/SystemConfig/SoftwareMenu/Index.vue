        ...
        <div
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-xl font-bold text-gray-800 dark:text-white">Software Menu Configuration</h1>
                        <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Manage global navigation structure for
            ...
            <div
                ...
                <form @submit.prevent="handleSearch" class="flex space-x-2">
                    <div class="relative">
                        <input type="text" v-model="searchQuery" placeholder="Search software menus..."
                            class="border dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-1.5 rounded-lg w-64 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 dark:text-white transition-all shadow-sm" />
                    ...
                    <button type="submit"
                        class="px-4 py-1.5 bg-emerald-600 text-white rounded-lg text-sm font-semibold hover:bg-emerald-700 transition shadow-sm hover:shadow active:scale-95">
                        Search
                    </button>
                </form>

                <Link :href="route('devAdmin.systemConfig.software.menu.create')"
            ...
            <DataTable :headers="['Menu Name', 'Route', 'Icon', 'Parent', 'Order', 'Status', 'Actions']"
                ...
                <template #empty>
                    <div class="flex flex-col items-center space-y-3 py-10">
                        ...
                        <h3 class="text-xl font-bold text-gray-900 dark:text-white">Empty Catalog</h3>
...
const handleSearch = () => {
    router.get(route('devAdmin.systemConfig.software.menu.index'), {
...
const deleteMenu = (id) => {
    if (confirm('Are you sure you want to permanently delete this software menu?')) {
        router.delete(route('devAdmin.systemConfig.software.menu.destroy', id))
    }
}
</script>
