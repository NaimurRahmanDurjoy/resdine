            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Add New Supplier</h1>
                            <p class="text-gray-600 dark:text-gray-400">Register a new product vendor</p>
                        </div>
                ...
                <!-- Form Body -->
                <div class="p-8">
                    <Form :supplier="null" :isEdit="false" @submit="submit" />
                </div>
            </div>
        </div>
    </AdminLayout>
...
const submit = (form) => {
    router.post(route('admin.suppliers.store'), form)
}
</script>
