<template>
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Manage your supplier information</p>
                        </div>
                    </div>
                </div>
            ...
            <!-- Content -->
            <ListTable :headers="headers" :items="suppliers.data" :pagination="suppliers" :sort="filters.sort"
