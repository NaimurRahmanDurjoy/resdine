<template>
    <div class="theme-panel overflow-hidden">
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Manage your restaurant customers and their
                            loyalty status</p>
                    </div>
                </div>
            </div>
            <div class="m-4 flex justify-between items-center">
                <div class="flex space-x-2">
                    <div class="relative max-w-sm w-full">
                        ...
                        <input v-model="search" type="text" placeholder="Search customers by name or email..."
        ...
        <ListTable :headers="headers" :items="customers.data" :pagination="customers" :sort="filters.sort"
                ...
                <tr v-for="customer in items" :key="customer.id"
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                        {{ customer.loyalty_points ? customer.loyalty_points.points_earned -
                            customer.loyalty_points.points_redeemed : 0 }} Pts
                    </td>
                    <td class="px-6 py-2 whitespace-nowrap">
            ...
            <template #pagination>
                <div class="flex items-center justify-between w-full">
                    <div class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-medium">{{ customers.from }}</span> to <span class="font-medium">{{
                            customers.to
