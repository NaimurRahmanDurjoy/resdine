<template>
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div class="bg-white dark:bg-gray-800">
            <div class="bg-gradient-to-r from-indigo-50 to-white dark:from-gray-700 dark:to-gray-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Update your basic details, profile photo, and password.</p>
                </div>
                <Link :href="route('admin.dashboard')" class="flex items-center text-sm text-indigo-600 hover:text-indigo-900 transition-colors">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-4">Personal Details</h2>
            ...
            <div class="flex items-start gap-4">
                ...
                <ImageUploadPreview
                    name="profile_photo"
                    :existingImage="user.profile?.profile_photo"
            ...
            <div class="flex flex-col md:flex-row md:items-start gap-2 md:gap-4">
                ...
                <textarea
                    ...
                    rows="3"
                    class="pl-3 border rounded border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition resize-none"
                ></textarea>
                <p v-if="profileForm.errors.address" class="text-red-500 text-sm mt-1">{{ profileForm.errors.address }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <input
                    ...
                    class="h-10 pl-3 border rounded border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"
                />
                <p v-if="profileForm.errors.dob" class="text-red-500 text-sm mt-1">{{ profileForm.errors.dob }}</p>
                </div>
                <div class="flex flex-col gap-1">
                ...
                <p v-if="profileForm.errors.gender" class="text-red-500 text-sm mt-1">{{ profileForm.errors.gender }}</p>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="flex-1 flex flex-col">
                    ...
                    type="password"
                    class="h-10 pl-3 border rounded border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:ring-2 focus:ring-green-500 focus:border-green-500 transition"
