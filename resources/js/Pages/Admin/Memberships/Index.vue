<template>
    <div class="theme-panel overflow-hidden">
            ...
            <div
                ...
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">Manage membership tiers and discount logic
                        </p>
                    </div>
                </div>
            </div>
            <div class="m-4 flex justify-between items-center">
                <div class="flex space-x-2">
                    <div class="relative max-w-sm w-full">
                        ...
                        <input v-model="search" type="text" placeholder="Search membership tiers..."
        ...
        <ListTable :headers="headers" :items="memberships.data" :pagination="memberships" :sort="filters.sort"
            ...
            <template #pagination>
                <div class="flex items-center justify-between w-full">
                    <div class="text-sm text-gray-700 dark:text-gray-400">
                        Showing <span class="font-medium">{{ memberships.from }}</span> to <span class="font-medium">{{
                            memberships.to
                            }}</span> of <span class="font-medium">{{ memberships.total }}</span> entries
                    </div>
                    <div class="flex space-x-1">
                        <Link v-for="(link, k) in memberships.links" :key="k" :href="link.url || '#'"
                            v-html="link.label"
