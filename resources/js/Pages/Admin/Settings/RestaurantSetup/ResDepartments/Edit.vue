            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Restaurant Department</h1>
                            <p class="text-gray-600 dark:text-gray-400">Update department details</p>
                        </div>
...
const submit = (form) => {
    router.put(route('admin.settings.restaurant-setup.res-departments.update', props.department.id), form)
}
</script>
