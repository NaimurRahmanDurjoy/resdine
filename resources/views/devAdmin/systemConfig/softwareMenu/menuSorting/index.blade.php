...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-indigo-50 to-white px-6 py-4 border-b border-gray-200">
        <h1 class="text-xl font-bold text-gray-800">Software Menu Sorting</h1>
    ...
    <div id="menuList" class="menu-group space-y-2 p-4">
        @foreach($menus as $menu)
            @include('devAdmin.systemConfig.softwareMenu.menuSorting.menuItem', ['menu' => $menu])
        @endforeach
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('saveOrder').addEventListener('click', function() {
        ...
        fetch('{{ route("devAdmin.systemConfig.software.menuSorting.updateOrder") }}', {
            method: 'POST',
            headers: {
